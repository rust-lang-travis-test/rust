...
// gdb-check:$2 = 1
// gdb-command:print *((i64[1]*)(singleton.data_ptr))
// gdb-check:$3 = {1}

// gdb-command:print multiple.length
// gdb-check:$4 = 4
// gdb-command:print *((i64[4]*)(multiple.data_ptr))
// gdb-check:$5 = {2, 3, 4, 5}

// gdb-command:print slice_of_slice.length
// gdb-check:$6 = 2
// gdb-command:print *((i64[2]*)(slice_of_slice.data_ptr))
// gdb-check:$7 = {3, 4}
...
// gdb-check:$14 = 2
// gdb-command:print *((i64[2]*)('vec_slices::MUT_VECT_SLICE'.data_ptr))
// gdb-check:$15 = {64, 65}

//gdb-command:print mut_slice.length
//gdb-check:$16 = 5
//gdb-command:print *((i64[5]*)(mut_slice.data_ptr))
